            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="grid md:grid-cols-3 gap-8 relative">
                    ...
                    <div className="relative z-10 group">
                        <div className="w-24 h-24 mx-auto bg-background border-4 border-border rounded-full flex items-center justify-center mb-6 group-hover:border-primary transition-colors duration-300">
                            <span className="text-4xl font-bold text-text-muted group-hover:text-primary transition-colors">
                                01
                            </span>
                        </div>
                        <div className="bg-surface-elevated p-8 rounded-xl shadow-lg border border-border hover:-translate-y-2 transition-transform duration-300 hover:shadow-primary/5 hover:border-primary/30">
                            ...
                            <h3 className="text-xl font-bold text-foreground mb-3">Prompt</h3>
                    ...
                    <div className="relative z-10 group">
                        ...
                        <div className="bg-surface-elevated p-8 rounded-xl shadow-lg border border-border hover:-translate-y-2 transition-transform duration-300 hover:shadow-primary/5 hover:border-primary/30">
                            ...
                            <h3 className="text-xl font-bold text-foreground mb-3">Refine</h3>
                            <p className="text-text-secondary leading-relaxed">
                    ...
                    <div className="relative z-10 group">
                        ...
                        <div className="bg-surface-elevated p-8 rounded-xl shadow-lg border border-border hover:-translate-y-2 transition-transform duration-300 hover:shadow-primary/5 hover:border-primary/30">
                            ...
                            <h3 className="text-xl font-bold text-foreground mb-3">Collaborate</h3>
                            <p className="text-text-secondary leading-relaxed">
